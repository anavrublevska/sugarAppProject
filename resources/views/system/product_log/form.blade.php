...
{{--    <div class="min-h-screen flex flex-col items-center sm:pt-10 bg-gray-100 pb-40">--}}
        <form method="{{ $productLog ? 'PUT' : 'POST' }}" action="{{ $productLog ? route('product-logs.update', $productLog) : route('product-logs.store') }}">
            @csrf
        <div class="sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg me">
            <div class="text-center mb-6 mt-4">
                <i class="fa-5x fas fa-syringe text-gray-500"></i>
            </div>
           <h3 class="text-center">Insulina</h3>
            <input type="time" name="insulin_hour" min="00:00" max="23:59" class="rounded-md bg-white text-slate-600 border-2 border-slate-300/50" style="width:100%;"/>
            <div class="mt-4">
                <x-bladewind::select
                    name="insulin_id"
                    required="true"
...
{{--            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">--}}
            <div class="sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg me">
                ...
                <input type="time" name="product_log_hour" min="00:00" max="23:59" class="rounded-md bg-white text-slate-600 border-2 border-slate-300/50" style="width:100%;"/>
                <div class="mt-4">
                    <x-bladewind::select
                        name="product_id"
                        required="true"
            ...
            <div class="sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg me">
                ...
                <input type="time" name="sugar_before_hour" min="00:00" max="23:59" class="rounded-md bg-white text-slate-600 border-2 border-slate-300/50" style="width:100%;"/>
                <div class="mt-4">
                    <x-bladewind::input
                        numeric="true"
                ...
                <input type="time" name="sugar_after_hour" min="00:00" max="23:59" class="rounded-md bg-white text-slate-600 border-2 border-slate-300/50" style="width:100%;"/>
                <div class="mt-4">
                    <x-bladewind::input
                        numeric="true"
